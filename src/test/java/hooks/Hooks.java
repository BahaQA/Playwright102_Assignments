...
public class Hooks {
    ...
    public void launchBrowser() {
        String browserName = BrowserUtils.getProperty("browser");  //Fetching browser value from config file
        driver = new Driver();
        page = driver.getDriver(browserName); // Passing browser name to launch the browser
    }
